	...
	<view class="uni-forms-item"
		...
		<slot name="label">
			<view class="uni-forms-item__label" :class="{'no-label':!label && !isRequired}"
				:style="{ justifyContent: localLabelAlign, alignItems: labelJustify, width: labelContentWidth }">
				<text v-if="isRequired" class="is-required">*</text>
				<text class="uni-forms-item__label___text" :class="{ 'uni-forms-item__label___long': longLabel }" :style="labelStyle">{{label}}</text>
				<!-- <rich-text class="uni-forms-item__label___text" :class="{ 'uni-forms-item__label___long': longLabel }" :style="labelStyle" :nodes="label"></rich-text> -->
			</view>
		</slot>
...
<style lang="scss">
	...
	.uni-forms-item__label___text {
		color: #333;
		font-size: 16px;
	}
	
	.uni-forms-item__label___long {
		width: 80px;
	}
