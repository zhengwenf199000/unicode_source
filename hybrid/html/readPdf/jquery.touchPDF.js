...
(function($) {
    ...
    function TouchPDF(element, options) {
        ...
        function goto(number,isFirst) {
            ...
            changePageNum(totalPages,pageNum,isFirst)
            // update tabs
            var z = 1;
        ...
        function initDom() {
            ...
            if (options.showToolbar) {
                ...
                $element.find(".pdf-toolbar").html(
                    ...
                    '<div class="pdf-button pdf-page-btn"><span class="pdf-page-count"></span></div>' +
        ...
        function redraw() {
            ...
            $element.find(".pdf-outerdiv")
                ...
                // $element.find(".pdf-outerdiv").attr('scale',scale)
        ...
        function renderAnnotations(page, viewport) {
            ...
            page.getAnnotations().then(function(annotationsData) {
                ...
                $.each(annotationsData, function(i, data) {
                    ...
                    var $el = $(pdfjsLib.AnnotationUtils.getHtmlElement(data, page.commonObjs));
                    var rect = data.rect;
                    var view = page.view;
