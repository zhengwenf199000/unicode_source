...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    createElementVNode("view", {
      ...
      $props.type === "password" && $props.passwordIcon ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
        ...
        }, null, 8, ["class", "type", "color", "onClick"])) : createCommentVNode("", true)
      ], 64)) : $props.suffixIcon ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
        ...
        }, null, 8, ["class", "size", "color", "onClick"])) : createCommentVNode("", true)
      ], 64)),
