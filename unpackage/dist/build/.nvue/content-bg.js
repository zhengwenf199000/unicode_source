  ...
  return openBlock(), createElementBlock("view", {
    ...
    createElementVNode("view", { class: "content-bg" }, [
      ...
      createElementVNode("view", { class: "content-bg_title" }, [
        ...
        }, toDisplayString($options.systemName) + "社区矫正自助终端", 1),
        $options.isCountdown ? (openBlock(), createElementBlock("u-text", {
          key: 0,
          class: "content-bg__countdown"
        }, toDisplayString($options.leftTime) + "秒后关闭", 1)) : createCommentVNode("", true)
      ]),
