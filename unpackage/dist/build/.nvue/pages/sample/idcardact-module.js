...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { class: "idcardact-container" }, [
      ...
      }, "读取中...")) : createCommentVNode("", true),
      $data.idCardInfo ? (openBlock(), createElementBlock("view", {
        key: 1,
        class: "id_card_info_c"
      }, [
        createElementVNode("u-text", null, "姓名：" + toDisplayString($data.idCardInfo.name), 1),
        createElementVNode("u-text", null, "性别：" + toDisplayString($data.idCardInfo.sex), 1),
        createElementVNode("u-text", null, "民族：" + toDisplayString($data.idCardInfo.nation), 1),
        createElementVNode("u-text", null, "出生：" + toDisplayString($data.idCardInfo.birthTime), 1),
        createElementVNode("u-text", null, "住址：" + toDisplayString($data.idCardInfo.address), 1),
        createElementVNode("u-text", null, "身份证号：" + toDisplayString($data.idCardInfo.number), 1),
        createElementVNode("u-text", null, "签发机关：" + toDisplayString($data.idCardInfo.issueOffice), 1),
        createElementVNode("u-text", null, "有效期：" + toDisplayString($data.idCardInfo.effectiveStartDate) + " - " + toDisplayString($data.idCardInfo.effectiveEndDate), 1),
      ...
      createElementVNode("u-text", null, toDisplayString($data.data), 1)
    ])
  ]);
}
const idcardactModule = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
