    ...
    createElementVNode("view", {
      ...
      createElementVNode("view", { class: "content-c" }, [
        createElementVNode("view", { class: "gather_content-breadcrumb" }, [
          ...
          createElementVNode("u-text", { class: "gather_content-breadcrumb--textaction" }, toDisplayString($options.status), 1)
        ]),
              ...
              default: withCtx(() => [
                createElementVNode("view", { class: "gather_content-c--fingerprint" }, [
                  ...
                  createElementVNode("view", { class: "gather_content-c--fingerprint---component" }, [
                    ...
                    $data.step === 1 ? (openBlock(), createBlock(_component_finger_print, {
                      key: 1,
                      ref: "fingerprint",
              ...
              default: withCtx(() => [
                createElementVNode("view", { class: "gather_content-c--audio" }, [
                  createElementVNode("view", { style: { "align-items": "center" } }, [
                    ...
                    createElementVNode("u-text", { class: "gather_content-c--audio---btn gather_content-c--audio---status" }, toDisplayString($data.recording ? "正在录制..." : ""), 1),
                    createElementVNode("u-text", { class: "gather_content-c--audio---tint" }, toDisplayString($data.recording ? "请点击录制按钮结束录制" : "请点击录制按钮，贴近麦克风开始录制"), 1)
                  ]),
...
const gather = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]]]);
export {
  gather as default
};
