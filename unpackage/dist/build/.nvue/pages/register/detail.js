    ...
    createElementVNode("view", {
      ...
      createElementVNode("view", { class: "content-c" }, [
        createElementVNode("view", { class: "register_detail_content-breadcrumb" }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.registerPaths, (path, i) => {
        ...
        createElementVNode("view", { class: "register_detail_content-c" }, [
          $options.currentPath === "recognizeFace" ? (openBlock(), createElementBlock("view", {
            ...
            $data.biosignatureStep === 2 ? (openBlock(), createElementBlock("scroller", {
              ...
              createElementVNode("u-text", { class: "register_detail_content-c-improveInfo-step2-audio register_detail_content-c-improveInfo-step2-audio_status" }, toDisplayString($data.recording ? "正在录音..." : ""), 1),
              createElementVNode("u-text", { class: "register_detail_content-c-improveInfo-step2-tint" }, toDisplayString($data.recording ? "请点击录制按钮结束录制" : "请点击录制按钮，贴近麦克风开始录制"), 1),
          ...
          $options.currentPath === "uploadDoc" ? (openBlock(), createElementBlock("view", {
            ...
            createElementVNode("scroller", { class: "register_detail_content-c-uploadDoc-left" }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($data.writObjects, (writ, i) => {
                return openBlock(), createElementBlock("view", {
