...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    $props.label ? (openBlock(), createElementBlock("span", {
      ...
      createElementVNode("u-text", null, toDisplayString($props.label + "："), 1)
      ...
      createElementVNode("view", {
        ...
        createElementVNode("view", {
          ...
          $options.multiCurrent ? (openBlock(), createElementBlock("view", {
            ...
            createElementVNode("u-text", null, toDisplayString($options.multiCurrent), 1)
          ])) : (openBlock(), createElementBlock("view", {
            key: 1,
            class: "uni-select__input-text uni-select__input-placeholder"
          }, [
            createElementVNode("u-text", null, toDisplayString($options.typePlaceholder), 1)
          ])),
        ...
        $data.showSelector ? (openBlock(), createElementBlock("view", {
          ...
          createElementVNode("scroll-view", {
            ...
            $data.mixinDatacomResData.length === 0 ? (openBlock(), createElementBlock("view", {
              ...
              createElementVNode("u-text", null, toDisplayString($props.emptyTips), 1)
            ])) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList($data.mixinDatacomResData, (item, index) => {
              return openBlock(), createElementBlock("view", {
                ...
                }, toDisplayString($options.formatItemName(item)), 3)
              ], 10, ["onClick"]);
            }), 128))
          ]),
