import { f as formatAppLog, a as requireNativePlugin } from "./uni-app.es.js";
import "vue";
//! moment.js
//! version : 2.30.1
...
const remoteResource = "http://39.101.178.159/JudicialTianJin/";
let moduleIdCardAct = {
  start: (cb) => {
...
{
  {
    const moduleIdCardActNative = requireNativePlugin("ModuleIDCardAct");
    moduleIdCardAct = {
      start: (cb) => {
        startPlayIdCardHintVoice();
        formatAppLog("log", "at utils/plugins.js:80", "moduleIdCardActNative start!");
...
const SIGN_IN_TYPE_MAPPER = { "公益活动": "1", "日常报到": "2", "教育学习": 3, "个别教育": "3", "集体教育": "3" };
let DEPT_ID = 5073;
const DeptIdStorageKey = "DeptIdStorageKey";
const updateDeptId = updateKeyHandler(DeptIdStorageKey, (v) => {
  DEPT_ID = parseInt(v);
});
updateDeptId();
let DEPT_NAME = "";
const DeptNameStorageKey = "DeptNameStorageKey";
const updateDeptName = updateKeyHandler(DeptNameStorageKey, (v) => {
  DEPT_NAME = v;
});
updateDeptName();
let systemName = "";
const systemNameStorageKey = "systemNameStorageKey";
const updateSystemName = updateKeyHandler(systemNameStorageKey, (v) => {
  systemName = v;
}, true);
updateSystemName();
let macAddress = "";
const macAddressStorageKey = "macAddressStorageKey";
const updateMacAddress = updateKeyHandler(macAddressStorageKey, (v) => {
  macAddress = v;
});
updateMacAddress();
const isDev = false;
let apiUrl = isDev ? "/api" : "http://59.206.216.141:9090";
const ApiUrlStorageKey = "ApiUrlStorageKey";
function getApiUrl() {
  return uni.getStorageSync(ApiUrlStorageKey) || apiUrl;
}
const updateApiUrl = updateKeyHandler(ApiUrlStorageKey, (v) => {
  apiUrl = v;
});
updateApiUrl();
const apis = {
...
export {
  DEPT_ID as D,
  SIGN_IN_TYPE_MAPPER as S,
  apis as a,
  apiUrl as b,
  DEPT_NAME as c,
  updateSystemName as d,
  updateApiUrl as e,
  updateMacAddress as f,
  updateDeptId as g,
  hooks as h,
  updateDeptName as i,
  macAddress as m,
