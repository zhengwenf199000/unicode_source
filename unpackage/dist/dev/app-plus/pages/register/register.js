...
(() => {
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/register/register.js
    ...
    return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("scroll-view", {
      ...
      (0, import_vue3.createElementVNode)("view", {
        ...
        (0, import_vue3.createElementVNode)("view", { class: "content-c" }, [
          (0, import_vue3.createElementVNode)("u-text", { class: "register_content-title" }, "\u81EA\u52A9\u767B\u8BB0"),
          (0, import_vue3.createElementVNode)("u-text", { class: "register_content-type" }, "\u8BF7\u9009\u62E9\u4E1A\u52A1\u7C7B\u578B"),
          (0, import_vue3.createElementVNode)("view", { class: "register_content-funcsc" }, [
            (0, import_vue3.createElementVNode)("view", { class: "register_content-funcs" }, [
              ((0, import_vue3.openBlock)(true), (0, import_vue3.createElementBlock)(
                ...
                (0, import_vue3.renderList)($data.funcItems, (func, i) => {
                  return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("u-image", {
                    class: (0, import_vue3.normalizeClass)(["register_content-funcs-f", { "register_content-funcs-first": i === 0 }]),
                    key: i,
                    src: func.icon,
                    mode: "heightFix",
              ...
              (0, import_vue3.createCommentVNode)(' <image class="register_content-funcs-f" src="@/static/register/PhysicalSignCollection.png" mode="heightFix"></image> ')
            ])
          ]),
  ...
  var register = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/register/register.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/register/register";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e) {
    }
    register.mpType = "page";
    const app = Vue.createPageApp(register, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...register.styles || []]));
    app.mount("#root");
  }
})();
