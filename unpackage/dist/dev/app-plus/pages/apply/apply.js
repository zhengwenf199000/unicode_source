...
(() => {
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/apply/apply.js
    ...
    return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("scroll-view", {
      ...
      (0, import_vue3.createElementVNode)("view", {
        ...
        (0, import_vue3.createElementVNode)("view", { class: "content-c" }, [
          (0, import_vue3.createElementVNode)("u-text", { class: "apply_content-title" }, "\u81EA\u52A9\u7533\u8BF7\u3001\u81EA\u52A9\u6253\u5370"),
          (0, import_vue3.createElementVNode)("u-text", { class: "apply_content-type" }, "\u8BF7\u9009\u62E9\u4E1A\u52A1\u7C7B\u578B"),
          (0, import_vue3.createElementVNode)("view", { class: "apply_content-funcsc" }, [
            (0, import_vue3.createElementVNode)("view", { class: "apply_content-funcs" }, [
              ((0, import_vue3.openBlock)(true), (0, import_vue3.createElementBlock)(
                ...
                (0, import_vue3.renderList)($data.funcItems, (func, i) => {
                  return (0, import_vue3.openBlock)(), (0, import_vue3.createElementBlock)("u-image", {
                    class: (0, import_vue3.normalizeClass)(["apply_content-funcs-f", { "apply_content-funcs-first": i === 0 }]),
                    key: i,
                    src: func.icon,
                    mode: "heightFix",
              ...
              (0, import_vue3.createCommentVNode)(' <image class="apply_content-funcs-f" src="@/static/apply/PhysicalSignCollection.png" mode="heightFix"></image> ')
            ])
          ]),
  ...
  var apply = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/apply/apply.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/apply/apply";
    let __pageQuery = {};
    try {
    ...
    apply.mpType = "page";
    const app = Vue.createPageApp(apply, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...apply.styles || []]));
    app.mount("#root");
  }
})();
