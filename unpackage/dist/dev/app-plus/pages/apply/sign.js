...
(() => {
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/apply/sign.js
  ...
  function zeroFill(number2, targetLength, forceSign) {
    var absNumber = "" + Math.abs(number2), zerosToFill = targetLength - absNumber.length, sign22 = number2 >= 0;
    return (sign22 ? forceSign ? "+" : "" : "-") + Math.pow(10, Math.max(0, zerosToFill)).toString().substr(1) + absNumber;
  }
  ...
  function offset(token2, separator) {
    addFormatToken(token2, 0, 0, function() {
      var offset2 = this.utcOffset(), sign22 = "+";
      if (offset2 < 0) {
        offset2 = -offset2;
        sign22 = "-";
      }
      return sign22 + zeroFill(~~(offset2 / 60), 2) + separator + zeroFill(~~offset2 % 60, 2);
    });
  }
  offset("Z", ":");
  offset("ZZ", "");
  ...
  function createDuration(input, key) {
    var duration = input, match = null, sign22, ret, diffRes;
    if (isDuration(input)) {
      duration = {
      ...
      duration = {
        y: 0,
        d: toInt(match[DATE]) * sign22,
        h: toInt(match[HOUR]) * sign22,
        m: toInt(match[MINUTE]) * sign22,
        s: toInt(match[SECOND]) * sign22,
        ms: toInt(absRound(match[MILLISECOND] * 1e3)) * sign22
        // the millisecond decimal point is included in the match
      };
    } else if (match = isoRegex.exec(input)) {
      sign22 = match[1] === "-" ? -1 : 1;
      duration = {
        y: parseIso(match[2], sign22),
        M: parseIso(match[3], sign22),
        w: parseIso(match[4], sign22),
        d: parseIso(match[5], sign22),
        h: parseIso(match[6], sign22),
        m: parseIso(match[7], sign22),
        s: parseIso(match[8], sign22)
      };
  ...
  function parseIso(inp, sign22) {
    var res = inp && parseFloat(inp.replace(",", "."));
    return (isNaN(res) ? 0 : res) * sign22;
  }
  ...
  function _sfc_render3(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_content_bg = resolveEasycom((0, import_vue5.resolveDynamicComponent)("content-bg"), __easycom_0);
    const _component_breadcrumb = resolveEasycom((0, import_vue5.resolveDynamicComponent)("breadcrumb"), __easycom_1);
    const _component_sign_pad = (0, import_vue5.resolveComponent)("sign-pad");
    const _component_button = (0, import_vue5.resolveComponent)("button");
    const _component_finger_print = (0, import_vue5.resolveComponent)("finger-print");
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("scroll-view", {
      ...
      (0, import_vue5.createElementVNode)(
        ...
        [
          (0, import_vue5.createVNode)(_component_content_bg),
          (0, import_vue5.createElementVNode)("view", { class: "content-nav" }, [
          ...
          (0, import_vue5.createElementVNode)("view", { class: "content-c sign_content" }, [
            (0, import_vue5.createVNode)(_component_breadcrumb, {
              title: "\u81EA\u52A9\u7533\u8BF7\u81EA\u52A9\u6253\u5370",
              actionTitle: "\u7B7E\u7F72"
            }),
            (0, import_vue5.createElementVNode)("view", { class: "actions" }, [
              (0, import_vue5.createElementVNode)("view", { class: "sign-pad-area" }, [
                (0, import_vue5.createVNode)(_component_sign_pad, {
                  ref: "signPad",
                  class: "sign-pad",
                ...
                (0, import_vue5.createVNode)(_component_button, {
                  ...
                  default: (0, import_vue5.withCtx)(() => [
                    (0, import_vue5.createTextVNode)("\u91CD\u7B7E")
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"]),
                (0, import_vue5.createCommentVNode)(' <button class="sign_content-backbtn" type="primary" @click="commitSign">\u786E\u8BA4</button> ')
              ]),
              (0, import_vue5.createElementVNode)("view", { class: "finger-area" }, [
                (0, import_vue5.createElementVNode)("view", { class: "finger-content" }, [
                  !$data.gettedFingerpath ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
                    key: 0,
                    ...
                    (0, import_vue5.createElementVNode)(
                      "u-text",
                      { class: "finger-tint" },
                      (0, import_vue5.toDisplayString)($data.isFinger ? "\u8BF7\u6309\u637A\u6307\u7EB9..." : "\u70B9\u51FB\u201C\u5F00\u59CB\u201D\u6309\u637A"),
                      1
                      /* TEXT */
                    )
                ...
                (0, import_vue5.createVNode)(_component_button, {
                  ...
                  default: (0, import_vue5.withCtx)(() => [
                    (0, import_vue5.createTextVNode)("\u5F00\u59CB")
                  ]),
                  _: 1
                  /* STABLE */
                }, 8, ["onClick"]),
            ...
            (0, import_vue5.createElementVNode)("view", { class: "sign_content-backbtns" }, [
              (0, import_vue5.createVNode)(_component_button, {
                class: "sign_content-backbtn",
                type: "primary",
                ...
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createTextVNode)("\u63D0\u4EA4")
                ]),
                _: 1
                /* STABLE */
              }, 8, ["onClick"]),
              (0, import_vue5.createCommentVNode)(' <button class="sign_content-backbtn" type="primary" @click="mockClick">\u6D4B\u8BD5\u5408\u5E76\u56FE\u7247\u5230pdf</button> '),
              (0, import_vue5.createVNode)(_component_button, {
                class: "sign_content-backbtn",
                type: "primary",
                ...
                default: (0, import_vue5.withCtx)(() => [
                  (0, import_vue5.createTextVNode)("\u8FD4\u56DE")
                ]),
                _: 1
                /* STABLE */
              }, 8, ["onClick"])
  ...
  var sign2 = /* @__PURE__ */ _export_sfc(_sfc_main3, [["render", _sfc_render3], ["styles", [_style_03]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/apply/sign.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/apply/sign";
    let __pageQuery = {};
    try {
    ...
    sign2.mpType = "page";
    const app = Vue.createPageApp(sign2, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...sign2.styles || []]));
    app.mount("#root");
  }
})();
//! moment.js
