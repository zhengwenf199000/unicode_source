...
(() => {
  ...
  function pe() {
    ...
    return ue = __spreadValues(__spreadValues({ PLATFORM: r2, OS: s2, APPID: i2, DEVICEID: n2 }, le()), t2), __spreadProps(__spreadValues(__spreadValues({}, de), ue), { locale: e2, LOCALE: e2 });
  }
  ...
  var lt = class extends it {
    signIn(e2, t2) {
      return __async(this, null, function* () {
        ...
        const { refreshTokenKey: n2 } = this._cache.keys, s2 = yield this._request.send("auth.signIn", { loginType: Ge.USERNAME, username: e2, password: t2, refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
        if (r2)
  ...
  var gt = function({ fileList: e2 }, t2) {
  ...
  var mt = function({ fileList: e2 }, t2) {
  ...
  var _t = function({ name: e2, data: t2, query: n2, parse: s2, search: r2, timeout: i2 }, o2) {
    const a2 = o2 || be();
    let c2;
    try {
  ...
  var Rt = class {
    ...
    setupLocalRequest(e2) {
      return __async(this, null, function* () {
        const t2 = pe(), { token: n2 } = oe(), s2 = Object.assign({}, e2, { spaceId: this.config.spaceId, timestamp: Date.now(), clientInfo: t2, token: n2 }), { address: r2, servePort: i2 } = this.__dev__ && this.__dev__.debugInfo || {}, { address: o2 } = yield Et(r2, i2);
  ...
  var Bt = class {
    ...
    uploadFile(_0) {
      return __async(this, arguments, function* ({ filePath: e2, cloudPath: t2 = "", fileType: n2 = "image", onUploadProgress: s2 }) {
        ...
        if (/:\/\//.test(t2))
          throw new se({ code: "INVALID_PARAM", message: "cloudPath\u4E0D\u5408\u6CD5" });
        const r2 = yield Kt({ path: "/".concat(t2.replace(/^\//, ""), "?post_url") }, this.config), { file_id: i2, upload_url: o2, form_data: a2 } = r2, c2 = a2 && a2.reduce((e3, t3) => (e3[t3.key] = t3.value, e3), {});
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), r3(i3);
  ...
  var { loginPage: Ss, routerNeedLogin: bs, resToLogin: ks, needLoginPage: Ts, notNeedLoginPage: As, loginPageInTabBar: Ps } = function({ pages: t2 = [], subPackages: n2 = [], uniIdRouter: s2 = {}, tabBar: r2 = {} } = e) {
  ...
  function Xs(e2) {
    return __async(this, null, function* () {
      ...
      if (!t2.debugInfo)
        return;
      const { address: n2, servePort: s2 } = t2.debugInfo, { address: r2 } = yield Et(n2, s2);
      if (r2)
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/sample/idcardact-module.js
  var import_vue4 = __toESM(require_vue());
  var _style_03 = { "idcardact-container": { "": { "flexDirection": "column", "alignItems": "center" } }, "idcardact-status": { "": { "marginTop": 20, "marginRight": 20, "marginBottom": 20, "marginLeft": 20 } }, "id_card_info_c": { "": { "width": "750rpx", "paddingTop": 10, "paddingRight": 10, "paddingBottom": 10, "paddingLeft": 10, "alignItems": "flex-start" } }, "id_card_info_c-photo": { "": { "position": "absolute", "right": 10, "width": 100, "height": 100, "backgroundColor": "#FAEBD7" } } };
  var moduleIdCardAct = requireNativePlugin("ModuleIDCardAct");
  var moduleFaceCompare = requireNativePlugin("ModuleFaceCompare");
  var _sfc_main3 = {
    data() {
      return {
        loading: true,
    ...
    methods: {
      change(e2) {
        formatAppLog("log", "at pages/sample/idcardact-module.nvue:62", e2);
      },
      getInfo() {
  ...
  function _sfc_render3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_uni_data_select = resolveEasycom((0, import_vue4.resolveDynamicComponent)("uni-data-select"), __easycom_0);
    return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
      ...
      (0, import_vue4.createElementVNode)("view", { class: "idcardact-container" }, [
        $data.loading ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("u-text", {
          key: 0,
          class: "idcardact-status"
        }, "\u8BFB\u53D6\u4E2D...")) : (0, import_vue4.createCommentVNode)("v-if", true),
        $data.idCardInfo ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
          key: 1,
          ...
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u59D3\u540D\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.name),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u6027\u522B\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.sex),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u6C11\u65CF\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.nation),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u51FA\u751F\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.birthTime),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u4F4F\u5740\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.address),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u8EAB\u4EFD\u8BC1\u53F7\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.number),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u7B7E\u53D1\u673A\u5173\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.issueOffice),
            1
            /* TEXT */
          ),
          (0, import_vue4.createElementVNode)(
            "u-text",
            null,
            "\u6709\u6548\u671F\uFF1A" + (0, import_vue4.toDisplayString)($data.idCardInfo.effectiveStartDate) + " - " + (0, import_vue4.toDisplayString)($data.idCardInfo.effectiveEndDate),
            1
            /* TEXT */
          ),
        ...
        (0, import_vue4.createVNode)(_component_button, {
          ...
          default: (0, import_vue4.withCtx)(() => [
            (0, import_vue4.createTextVNode)("\u83B7\u53D6\u8EAB\u4EFD\u4FE1\u606F")
          ]),
          _: 1
          /* STABLE */
        }, 8, ["onClick"]),
        (0, import_vue4.createVNode)(_component_uni_data_select, {
        ...
        (0, import_vue4.createElementVNode)(
          "u-text",
          null,
          (0, import_vue4.toDisplayString)($data.data),
          1
          /* TEXT */
        )
      ])
  ...
  var idcardactModule = /* @__PURE__ */ _export_sfc(_sfc_main3, [["render", _sfc_render3], ["styles", [_style_03]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/sample/idcardact-module.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/sample/idcardact-module";
    let __pageQuery = {};
    try {
      __pageQuery = JSON.parse(webview.__query__);
    } catch (e2) {
    }
    idcardactModule.mpType = "page";
    const app = Vue.createPageApp(idcardactModule, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...idcardactModule.styles || []]));
    app.mount("#root");
  }
})();
