...
(() => {
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/query/common.js
  ...
  var _sfc_main3 = {
    ...
    methods: {
      viewBtnClick(index2, title) {
        this.$emit("viewBtnClick", index2, title);
      },
      getViewTitles(title) {
  ...
  function _sfc_render3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("view", {
      ...
      (0, import_vue4.createElementVNode)("view", { class: "action-table" }, [
        (0, import_vue4.createElementVNode)("view", { class: "action-table--row action-table--radius" }, [
          ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(
            import_vue4.Fragment,
            null,
            (0, import_vue4.renderList)($props.tableMapper, (mapper, i) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(
                "view",
                {
                  class: (0, import_vue4.normalizeClass)(["action-table-th", { isView: mapper.isView }]),
                  key: i
                },
                [
                  (0, import_vue4.createElementVNode)(
                    "u-text",
                    { class: "action-table-th--text" },
                    (0, import_vue4.toDisplayString)(mapper.name),
                    1
                    /* TEXT */
                  )
                ],
      ...
      (0, import_vue4.createElementVNode)("scroller", { class: "action-scroller" }, [
        (0, import_vue4.createElementVNode)("view", { class: "action-table" }, [
          ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(
            import_vue4.Fragment,
            null,
            (0, import_vue4.renderList)($props.tableData, (item, index2) => {
              return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(
                "view",
                {
                  class: (0, import_vue4.normalizeClass)(["action-table--row", { "action-table--rowodd": index2 % 2 === 1, "action-table--roweven": index2 % 2 === 0 }]),
                  key: index2
                },
                [
                  ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(
                    ...
                    (0, import_vue4.renderList)($props.tableMapper, (mapper, i) => {
                      return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(
                        "view",
                        {
                          class: (0, import_vue4.normalizeClass)(["action-table-td", { isView: mapper.isView }]),
                          key: i
                        },
                        [
                          mapper.isView ? ((0, import_vue4.openBlock)(true), (0, import_vue4.createElementBlock)(
                            import_vue4.Fragment,
                            { key: 0 },
                            (0, import_vue4.renderList)($options.getViewTitles(mapper.viewTitle), (title, i2) => {
                              return (0, import_vue4.openBlock)(), (0, import_vue4.createBlock)(_component_button, {
                                key: i2,
                                class: "action-table-body--btn",
                                type: "primary",
                                size: "mini",
                                onClick: ($event) => $options.viewBtnClick(index2, title)
                              }, {
                                default: (0, import_vue4.withCtx)(() => [
                                  (0, import_vue4.createTextVNode)(
                                    (0, import_vue4.toDisplayString)(title),
                                    1
                                    /* TEXT */
                                  )
                                ]),
                            ...
                            128
                            /* KEYED_FRAGMENT */
                          )) : mapper.isImage ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("u-image", {
                            key: 1,
                            ...
                            (0, import_vue4.toDisplayString)($options.tdText(item, mapper)),
                            1
                            /* TEXT */
                          ))
                        ],
  ...
  function _sfc_render4(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_button = (0, import_vue5.resolveComponent)("button");
    return (0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
      ...
      (0, import_vue5.createElementVNode)(
        ...
        (0, import_vue5.toDisplayString)($props.text),
        1
        /* TEXT */
      ),
      $props.action ? ((0, import_vue5.openBlock)(), (0, import_vue5.createElementBlock)("view", {
        key: 0,
        class: "empty-view--action"
      }, [
        (0, import_vue5.createElementVNode)(
          "u-text",
          { class: "empty-view--action---text" },
          (0, import_vue5.toDisplayString)($props.actionTitle),
          1
          /* TEXT */
        ),
        (0, import_vue5.createVNode)(_component_button, {
          ...
          default: (0, import_vue5.withCtx)(() => [
            (0, import_vue5.createTextVNode)(
              (0, import_vue5.toDisplayString)($props.actionBtnTitle),
              1
              /* TEXT */
            )
          ]),
  ...
  var __easycom_3 = /* @__PURE__ */ _export_sfc(_sfc_main4, [["render", _sfc_render4], ["styles", [_style_04]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/components/empty-view/empty-view.vue"]]);
  ...
  var _imports_03 = "/static/imgs/Home.png";
  ...
  var _style_05 = { "query-common_content-backbtn": { ".query-common_content ": { "alignSelf": "flex-end", "width": 100, "backgroundColor": "#006AEC", "marginTop": 10, "marginRight": 0, "marginBottom": 10, "marginLeft": 0 } } };
  var _sfc_main5 = {
    ...
    methods: {
      ...
      viewBtnClick(index2) {
        const act = this.activitys[index2];
  ...
  function _sfc_render5(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_action_table = resolveEasycom((0, import_vue7.resolveDynamicComponent)("action-table"), __easycom_2);
    const _component_empty_view = resolveEasycom((0, import_vue7.resolveDynamicComponent)("empty-view"), __easycom_3);
    ...
    return (0, import_vue7.openBlock)(), (0, import_vue7.createElementBlock)("scroll-view", {
      ...
      (0, import_vue7.createElementVNode)(
        ...
        [
          ...
          (0, import_vue7.createElementVNode)("view", { class: "content-c query-common_content" }, [
            (0, import_vue7.createVNode)(_component_breadcrumb, {
              title: "\u4FE1\u606F\u67E5\u8BE2",
              actionTitle: $data.title
            }, null, 8, ["actionTitle"]),
            $data.activitys.length > 0 ? ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(_component_action_table, {
              key: 0,
              tableMapper: $data.tableMapper,
              tableData: $data.activitys,
              onViewBtnClick: $options.viewBtnClick
            }, null, 8, ["tableMapper", "tableData", "onViewBtnClick"])) : ((0, import_vue7.openBlock)(), (0, import_vue7.createBlock)(_component_empty_view, {
              key: 1,
              text: `\u6682\u65E0${$data.title}`,
              action: false,
  ...
  var common = /* @__PURE__ */ _export_sfc(_sfc_main5, [["render", _sfc_render5], ["styles", [_style_05]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/query/common.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/query/common";
    let __pageQuery = {};
    try {
    ...
    common.mpType = "page";
    const app = Vue.createPageApp(common, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...common.styles || []]));
    app.mount("#root");
  }
})();
//! moment.js
