...
(() => {
  ...
  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/compound/daily.js
  ...
  var _imports_03 = "/static/imgs/success.png";

  // ../../../../../../Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/unpackage/dist/dev/.nvue/pages/compound/daily.js
  var _imports_2 = "/static/imgs/failure.png";
  var _style_02 = { "daily_content": { "": { "alignItems": "center", "justifyContent": "space-around" } }, "daily_content-icon": { ".daily_content ": { "width": 150, "height": 150 } }, "daily_content-status": { ".daily_content ": { "marginTop": 25, "fontSize": 26, "fontWeight": "bold", "color": "#006AEC" } }, "daily_content-timeout": { ".daily_content ": { "fontSize": 20, "color": "#006AEC" } } };
  var _sfc_main2 = {
    data() {
      return {
        success: false,
  ...
  function _sfc_render2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("scroll-view", {
      ...
      (0, import_vue4.createElementVNode)("view", { class: "content" }, [
        ...
        (0, import_vue4.createElementVNode)("view", { class: "content-c daily_content" }, [
          (0, import_vue4.createElementVNode)("view", { class: "daily_content" }, [
            $data.success ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("u-image", {
              key: 0,
              class: "daily_content-icon",
              src: _imports_03
            })) : (0, import_vue4.createCommentVNode)("v-if", true),
            $data.failure ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)("u-image", {
              key: 1,
              class: "daily_content-icon",
              src: _imports_2
            })) : (0, import_vue4.createCommentVNode)("v-if", true),
            (0, import_vue4.createElementVNode)(
              ...
              (0, import_vue4.toDisplayString)($data.name) + " \u60A8\u597D\uFF0C" + (0, import_vue4.toDisplayString)(!$data.success && !$data.failure ? "\u6B63\u5728\u7B7E\u5230..." : "") + (0, import_vue4.toDisplayString)($data.success ? "\u60A8\u5DF2\u6210\u529F\u7B7E\u5230\uFF01" : "") + (0, import_vue4.toDisplayString)($data.failure ? "\u7B7E\u5230\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5\uFF01" : ""),
              1
              /* TEXT */
            )
          ]),
          $data.success || $data.failure ? ((0, import_vue4.openBlock)(), (0, import_vue4.createElementBlock)(
            "u-text",
            {
              key: 0,
              class: "daily_content-timeout"
            },
            (0, import_vue4.toDisplayString)($data.leftSecond) + " \u79D2\u540E\u81EA\u52A8\u5173\u95ED",
            1
            /* TEXT */
          )) : (0, import_vue4.createCommentVNode)("v-if", true)
        ])
  ...
  var daily = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/compound/daily.nvue"]]);

  // <stdin>
  var webview = plus.webview.currentWebview();
  if (webview) {
    const __pageId = parseInt(webview.id);
    const __pagePath = "pages/compound/daily";
    let __pageQuery = {};
    try {
    ...
    daily.mpType = "page";
    const app = Vue.createPageApp(daily, { $store: getApp({ allowDefault: true }).$store, __pageId, __pagePath, __pageQuery });
    app.provide("__globalStyles", Vue.useCssStyles([...__uniConfig.styles, ...daily.styles || []]));
    app.mount("#root");
  }
})();
//! moment.js
