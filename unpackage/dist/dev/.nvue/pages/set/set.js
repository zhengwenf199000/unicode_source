      ...
      renderSlot(_ctx.$slots, "label", {}, () => [
        createElementVNode(
          ...
          [
            ...
            createCommentVNode(` <rich-text class="uni-forms-item__label___text" :class="{ 'uni-forms-item__label___long': longLabel }" :style="labelStyle" :nodes="label"></rich-text> `)
          ],
          6
          /* CLASS, STYLE */
        )
...
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["styles", [_style_0$1]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/components/forms-item/forms-item.vue"]]);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { class: "content set_content" }, [
      ...
      createCommentVNode(' <view class="set_content-placeholder"></view> '),
        ...
        createElementVNode("view", {
          ...
          createElementVNode("view", { class: "set_content-versions" }, [
            createElementVNode(
              ...
              "应用版本：v " + toDisplayString($data.appVersion),
              1
              /* TEXT */
            ),
          ...
          createElementVNode("view", { class: "set_content-versions" }, [
            createElementVNode(
              "u-text",
              { class: "set_content-versions--text" },
              "内核版本：" + toDisplayString($data.wgtVersion),
              1
              /* TEXT */
            ),
      ...
      createElementVNode("view", { class: "content-c set_content-c" }, [
        createCommentVNode(' <scroller class="content-scroller"> '),
        ...
        createElementVNode("scroller", { class: "set_content-c--list" }, [
          createElementVNode("view", {
            ...
            (openBlock(true), createElementBlock(
              Fragment,
              null,
              renderList($options.searchedJustices, (justice, i) => {
                return openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode("view", {
                    ...
                    createElementVNode(
                      ...
                      toDisplayString(justice.deptName),
                      1
                      /* TEXT */
                    )
                  ]),
...
const set = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/set/set.nvue"]]);
export {
  set as default
};
