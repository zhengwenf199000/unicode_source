...
import { resolveDynamicComponent, resolveComponent, openBlock, createElementBlock, createElementVNode, createVNode, withCtx, createTextVNode, createCommentVNode, toDisplayString } from "vue";
        ...
        createElementVNode("view", { class: "content-c sign_content" }, [
          ...
          createElementVNode("view", { class: "actions" }, [
            createElementVNode("view", { class: "sign-pad-area" }, [
              ...
              createCommentVNode(' <button class="sign_content-backbtn" type="primary" @click="commitSign">确认</button> ')
            ]),
              ...
              createElementVNode("view", { class: "finger-content" }, [
                !$data.gettedFingerpath ? (openBlock(), createElementBlock("view", {
                  ...
                  createElementVNode(
                    "u-text",
                    { class: "finger-tint" },
                    toDisplayString($data.isFinger ? "请按捺指纹..." : "点击“开始”按捺"),
                    1
                    /* TEXT */
                  )
          ...
          createElementVNode("view", { class: "sign_content-backbtns" }, [
            ...
            createCommentVNode(' <button class="sign_content-backbtn" type="primary" @click="mockClick">测试合并图片到pdf</button> '),
            createVNode(_component_button, {
              class: "sign_content-backbtn",
              type: "primary",
...
const sign = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/apply/sign.nvue"]]);
export {
  sign as default
};
