...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("scroll-view", {
    ...
    createElementVNode("view", { style: { "display": "flex", "align-items": "center" } }, [
      ...
      }, "正在检测中。。。")) : createCommentVNode("v-if", true),
      ...
      createCommentVNode(' <alive-detect style="width: 250px; height: 250px; margin-top: 20px; background-color: papayawhip;" cameratype="black" @detecting="detecting" @detectFailure="detectFailure" @detectSuccess="detectSuccess" @angleChange="angleChange"></alive-detect> '),
      ...
      createElementVNode(
        ...
        "角度：仰角" + toDisplayString($data.pitchAngle) + " 左右角度" + toDisplayString($data.yawAngle) + " 摆动角度" + toDisplayString($data.rollAngle),
        1
        /* TEXT */
      ),
      createCommentVNode(' <button type="primary" @click="testAsyncFunc">testAsyncFunc</button>\n		<button type="primary" @click="testSyncFunc">testSyncFunc</button>\n		<button type="primary" @click="gotoNativePage">跳转原生Activity</button> ')
    ])
  ]);
}
const extModule = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/pages/sample/ext-module.nvue"]]);
export {
