import { resolveDynamicComponent, resolveComponent, openBlock, createElementBlock, createElementVNode, toDisplayString, createCommentVNode, normalizeClass, createBlock, Fragment, renderList, withCtx, createTextVNode } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    createElementVNode(
      "view",
      {
        class: normalizeClass(["uni-stat-box", { "uni-stat__actived": $data.current }])
      },
      [
        createElementVNode(
          "view",
          {
            class: normalizeClass(["uni-select", { "uni-select--disabled": $props.disabled }])
          },
          [
            createElementVNode("view", {
              ...
              $options.multiCurrent ? (openBlock(), createElementBlock("view", {
                key: 0,
                ...
                createElementVNode(
                  "u-text",
                  null,
                  toDisplayString($options.multiCurrent),
                  1
                  /* TEXT */
                )
                ...
                createElementVNode(
                  "u-text",
                  null,
                  toDisplayString($options.typePlaceholder),
                  1
                  /* TEXT */
                )
              ])),
              $options.multiCurrent && $props.clear ? (openBlock(), createBlock(_component_uni_icons, {
                key: 2,
                type: "clear",
                color: "#c0c4cc",
                size: "24",
                onClick: $options.clearVal
              }, null, 8, ["onClick"])) : (openBlock(), createBlock(_component_uni_icons, {
                key: 3,
            ...
            $data.showSelector ? (openBlock(), createElementBlock("view", {
              key: 0,
            ...
            $data.showSelector ? (openBlock(), createElementBlock("view", {
              ...
              createElementVNode("scroll-view", {
                ...
                $data.mixinDatacomResData.length === 0 ? (openBlock(), createElementBlock("view", {
                  key: 0,
                  ...
                  createElementVNode(
                    "u-text",
                    null,
                    toDisplayString($props.emptyTips),
                    1
                    /* TEXT */
                  )
                  ...
                  Fragment,
                  { key: 1 },
                  renderList($data.mixinDatacomResData, (item, index) => {
                    return openBlock(), createElementBlock("view", {
                      class: normalizeClass(["uni-select__selector-item", { "uni-select__selector-checked": $options.containsItem(item) }]),
                      key: index,
                      ...
                      createElementVNode(
                        "u-text",
                        {
                          class: normalizeClass({ "uni-select__selector__disabled": item.disable })
                        },
                        toDisplayString($options.formatItemName(item)),
                        3
                        /* TEXT, CLASS */
                      )
                    ], 10, ["onClick"]);
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/uni_modules/uni-data-select/components/uni-data-select/uni-data-select.vue"]]);
export {
  __easycom_0 as _,
  nr as n
};
