    ...
    createElementVNode("view", { class: "action-table" }, [
      createElementVNode("view", { class: "action-table--row action-table--radius" }, [
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList($props.tableMapper, (mapper, i) => {
    ...
    createElementVNode("scroller", { class: "action-scroller" }, [
      createElementVNode("view", { class: "action-table" }, [
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList($props.tableData, (item, index) => {
            return openBlock(), createElementBlock(
              "view",
              {
                ...
                (openBlock(true), createElementBlock(
                  ...
                  renderList($props.tableMapper, (mapper, i) => {
                    return openBlock(), createElementBlock(
                      ...
                      [
                        mapper.isView ? (openBlock(true), createElementBlock(
                          Fragment,
                          { key: 0 },
                          renderList($options.getViewTitles(mapper.viewTitle), (title, i2) => {
                          ...
                          128
                          /* KEYED_FRAGMENT */
                        )) : mapper.isImage ? (openBlock(), createElementBlock("u-image", {
                          key: 1,
                          ...
                          toDisplayString($options.tdText(item, mapper)),
                          1
                          /* TEXT */
                        ))
                      ],
...
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/components/action-table/action-table.vue"]]);
export {
  __easycom_2 as _
};
