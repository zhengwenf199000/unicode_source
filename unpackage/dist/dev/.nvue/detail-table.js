...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("scroller", { class: "detail-table" }, [
    (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList($props.detailMapper, (cols, i) => {
              ...
              return openBlock(), createElementBlock("view", {
                ...
                createElementVNode("view", { class: "detail-table--col---item detail-table--col---right" }, [
                  col.isImage ? (openBlock(), createElementBlock("u-image", {
                    ...
                    toDisplayString($options.tdText($props.detailData, col)),
                    1
                    /* TEXT */
                  ))
                ])
...
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/yumingzhang/Desktop/my_porject/smart-correct-tianjin/unicode_source/components/detail-table/detail-table.vue"]]);
export {
  __easycom_2 as _
};
